...
`);
  ...
  function createTab(tabId, index) {
    ...
    const term = new import_xterm.Terminal({ cursorBlink: true, fontSize: 14, fontFamily: "'JetBrains Mono', 'Fira Code', 'SF Mono', monospace", theme: termTheme });
  ...
  function startFollowing(userId, userName) {
    ...
    followTerm = new import_xterm.Terminal({
      cursorBlink: false,
      fontSize: 14,
    ...
    followFitAddon = new import_xterm_addon_fit.FitAddon();
